...
//HOWTO COMPILE & MAKE WORK:

// 1b) Add _wsbw function to code.
// 3) Check syntax of all functions with "int addr"/"int buffer"
//    to see if they do pointer stuff correctly.
//    I was lazy so no void*, just int for addr.
// 4) Call MS_INIT
// 5) Call MS_READBLOCK with params
// 6) Figure out what provokes that crash you just had.
//    (I'm ready to bet money that it will crash although i didn't test it)
